...
pxf_gp5_el6_releng_url="${RELENG_DROP_URL}/gpdb5/pxf-gp5-${version}-2.el6.x86_64.rpm"
...
pxf_gp5_tarball_releng_url="${RELENG_DROP_URL}/gpdb5/pxf-gp5-${version}-el6.x86_64.tar.gz"
